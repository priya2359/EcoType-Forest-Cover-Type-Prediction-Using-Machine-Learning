...
plt.tight_layout()
os.makedirs('../reports/figures/cleaning', exist_ok=True)
plt.savefig('../reports/figures/cleaning/01_outlier_boxplots.png', dpi=150, bbox_inches='tight')
plt.close()
print("Chart saved: reports/figures/cleaning/01_outlier_boxplots.png")
